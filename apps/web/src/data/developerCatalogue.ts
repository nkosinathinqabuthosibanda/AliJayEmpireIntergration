...
export const HUB_VERSION = '1.5.1'

export const developerSystems = integrations
  .filter((s) => s.availability === 'live' && s.url)
  .map((system) => ({
    id: system.id,
    name: system.name,
...
export const changelog = [
  {
    ...
    date: '2026-05-20',
    items: [
      'Alijay Cloud live at cloud.alijayempire.co.za',
      'Developer Catalogue enabled in header, footer, and hub',
    ],
  },
  {
    version: '1.5.0',
    date: '2026-05-20',
    items: [
      'Alijay Empire Cloud added to system list',
      'Uniform system cards across the hub',
      'Empire AI marked coming soon',
    ],
  },
  {
    version: '1.4.0',
